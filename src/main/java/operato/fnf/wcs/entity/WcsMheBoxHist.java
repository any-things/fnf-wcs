 ...
 */
@Table(name = "mhe_box_hists", idStrategy = GenerationRule.UUID, uniqueFields="whCd,workUnit,shiptoId,itemCd,boxNo,boxSeq", indexes = {
	@Index(name = "ix_mhe_box_hists_01", columnList = "wh_cd,work_unit,shipto_id,item_cd,box_no,box_seq"),
	@Index(name = "ix_mhe_box_hists_02", columnList = "work_unit,outb_no,box_no"),
	@Index(name = "ix_mhe_box_hists_03", columnList = "work_date,strr_id,mhe_no,box_no")
})
public class WcsMheBoxHist extends xyz.elidom.orm.entity.basic.AbstractStamp {
