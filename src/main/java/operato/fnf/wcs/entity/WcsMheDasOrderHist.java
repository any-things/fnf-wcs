...
@Table(name = "mhe_das_order_hists", idStrategy = GenerationRule.UUID, uniqueFields="batchNo,mheNo,jobDate,jobType,cellNo,item_cd", indexes = {
	@Index(name = "ix_mhe_das_order_hists_01", columnList = "batch_no,mhe_no,job_date,job_type,cell_no,item_cd")
})
public class WcsMheDasOrderHist extends xyz.elidom.orm.entity.basic.AbstractStamp {
	/**
	 * SerialVersion UID
	 */
