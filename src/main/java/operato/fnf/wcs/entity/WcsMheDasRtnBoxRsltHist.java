...
@Table(name = "mhe_das_rtn_box_rslt_hists", idStrategy = GenerationRule.UUID, uniqueFields = "whCd,mheNo,sortDate,itemCd,boxNo,boxSeq", indexes = {
		@Index(name = "ix_mhe_das_rtn_box_hists_1", columnList = "wh_cd,mhe_no,sort_date,item_cd,box_no,box_seq"),
		@Index(name = "ix_mhe_das_rtn_box_hists_2", columnList = "mhe_no,sort_date,box_no") })
public class WcsMheDasRtnBoxRsltHist extends xyz.elidom.orm.entity.basic.AbstractStamp {
	/**
	 * SerialVersion UID
	 */
