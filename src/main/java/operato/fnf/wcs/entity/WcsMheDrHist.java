 ...
 * 상세 분배 지시내역 - DAS, DPS
 */
@Table(name = "mhe_dr_hists", idStrategy = GenerationRule.UUID, uniqueFields="whCd,workUnit,shiptoId,outbNo,locationCd,itemCd", indexes = {
	@Index(name = "ix_mhe_dr_hists_01", columnList = "wh_cd,work_unit,shipto_id,outb_no,location_cd,item_cd"),
	@Index(name = "ix_mhe_dr_hists_02", columnList = "work_unit,biz_type,ref_no"),
	@Index(name = "ix_mhe_dr_hists_03", columnList = "work_unit,status,box_no,box_id,box_input_seq"),
	@Index(name = "ix_mhe_dr_hists_04", columnList = "work_unit,chute_no,item_cd")
})
public class WcsMheDrHist extends xyz.elidom.orm.entity.basic.AbstractStamp {
