...
@RequestMapping("/rest/mhe_dr_recycle")
@ServiceDesc(description="WcsMheDrRecycle Service API")
public class WcsMheDrRecycleController extends AbstractRestService {
