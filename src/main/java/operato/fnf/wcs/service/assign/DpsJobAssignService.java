...
public class DpsJobAssignService extends AbstractQueryService {
	...
	public int assignJob(DpsJobAssign candidate, int stockQty, int orderQty, List<String> skipOrderList) {
		...
		dpsJobQry.add("insert into dps_job_instances(id, mhe_dr_id, dps_assign_yn, dps_assign_at, cell_cd, status, wh_cd, strr_id, strr_nm, work_date, work_unit, wave_no, workseq_no, outb_tcd, outb_no, ref_no, shipto_id, shipto_nm, item_cd, item_nm, item_season, item_style, item_color, item_size, barcode, barcode2, pick_qty, cmpt_qty, mhe_no, pack_tcd, rfid_item_yn, box_input_seq, outb_ect_date)")
