SELECT 
	MPO.JOB_DATE, MPO.BATCH_NO AS BATCH_ID, JB.TITLE
	, MPO.CHUTE_NO, DAS.CELL_NO, DAS.SHOP_CD, DAS.SHOP_NM
	, MPO.SKU_CD, MPO.SKU_BCD, SKU.BRAND_CD, SKU.SEASON_CD
	, SKU.STYLE_CD, SKU.COLOR_CD, SKU.SIZE_CD
	, MPO.ORDER_QTY, COALESCE(MPR.QTY, 0) AS QTY
	, COALESCE(DAS.CMPT_QTY, 0) AS CMPT_QTY
