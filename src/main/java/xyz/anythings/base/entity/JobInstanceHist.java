...
@Table(name = "job_instance_hists", idStrategy = GenerationRule.UUID, indexes = {
	@Index(name = "ix_job_instance_hists_1", columnList = "batch_id,domain_id"),
	@Index(name = "ix_job_instance_hists_2", columnList = "order_no,batch_id"),
	@Index(name = "ix_job_instance_hists_3", columnList = "box_id,invoice_id,batch_id"),
	@Index(name = "ix_job_instance_hists_4", columnList = "status,equip_type,equip_cd,sub_equip_cd,batch_id"),
	@Index(name = "ix_job_instance_hists_5", columnList = "status,job_date,job_seq,batch_id"),
	@Index(name = "ix_job_instance_hists_6", columnList = "input_seq,sub_equip_cd,sku_cd,status,batch_id")
})
public class JobInstanceHist extends xyz.elidom.orm.entity.basic.ElidomStampHook {
	/**
	 * SerialVersion UID
	 */
